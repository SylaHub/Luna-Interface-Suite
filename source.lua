...
function Luna:CreateWindow(WindowSettings)
	...
	WindowSettings.KeySettings.SecondAction = Kwargify({
		Enabled = false,
		Type = "https://dsc.gg/astrolua", -- Link/Discord
	...
	LoadingFrame.Version.Text = LoadingFrame.Frame.Frame.Title.Text == "Luna Interface Suite" and Release or "Astro Lua"
	...
	local rank
		...
		HomeTabPage.detailsholder.dashboard.Discord.Interact.MouseButton1Click:Connect(function()
			setclipboard(tostring("https://dsc.gg/astrolua"..HomeTabSettings.DiscordInvite)) -- Hunter if you see this I added copy also was too lazy to send u msg
			if request then
				request({
					Url = 'http://127.0.0.1:6463/rpc?v=1',
					Method = 'POST',
